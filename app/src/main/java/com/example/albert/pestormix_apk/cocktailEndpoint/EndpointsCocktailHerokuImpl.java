...
public class EndpointsCocktailHerokuImpl implements CocktailBag {
    ...
    public void pushToRemote(String userId) {
        try {
            ...
            messaging.messagingEndpoint().sendMessage("Custom PushToRemote by " + pestormixApplication.getString(Constants.PREFERENCES_USER_NAME, "Default")).execute();
    ...
    public List<CocktailBean> pullFromRemote(String userId) {
        ...
        try {
            messaging.messagingEndpoint().sendMessage("Custom PullFromRemote by " + pestormixApplication.getString(Constants.PREFERENCES_USER_NAME, "Default")).execute();
