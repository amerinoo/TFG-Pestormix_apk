...
/**
 * Created by Albert on 18/03/2016.
 */
public class RoundedDrawable extends Drawable {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            Bitmap bm = drawableToBitmap(drawable, -1, -1);
            if (bm != null) {
    ...
    public static Bitmap drawableToBitmap(Drawable drawable, int width, int height) {
        ...
        Bitmap bitmap;
        if (width == -1)
            width = Math.max(drawable.getIntrinsicWidth(), 1);
        if (height == -1)
            height = Math.max(drawable.getIntrinsicHeight(), 1);
        try {
    ...
    public Bitmap toBitmap(int width, int height) {
        return drawableToBitmap(this, width, height);
    }
